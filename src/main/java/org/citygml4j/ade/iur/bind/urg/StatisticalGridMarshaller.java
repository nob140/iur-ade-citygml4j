...
import jp.go.chisou.iur._1_5.urg.AreaOfAnnualDiversionsPropertyType;
import jp.go.chisou.iur._1_5.urg.AreaOfAnnualDiversionsType;
import jp.go.chisou.iur._1_5.urg.GenericGridCellType;
import jp.go.chisou.iur._1_5.urg.HouseholdsType;
import jp.go.chisou.iur._1_5.urg.KeyValuePairPropertyType;
import jp.go.chisou.iur._1_5.urg.KeyValuePairType;
import jp.go.chisou.iur._1_5.urg.LandPricePerLandUsePropertyType;
import jp.go.chisou.iur._1_5.urg.LandPricePerLandUseType;
import jp.go.chisou.iur._1_5.urg.LandPriceType;
import jp.go.chisou.iur._1_5.urg.LandUseDiversionType;
import jp.go.chisou.iur._1_5.urg.NumberOfAnnualDiversionsPropertyType;
import jp.go.chisou.iur._1_5.urg.NumberOfAnnualDiversionsType;
import jp.go.chisou.iur._1_5.urg.NumberOfHouseholdsPropertyType;
import jp.go.chisou.iur._1_5.urg.NumberOfHouseholdsType;
import jp.go.chisou.iur._1_5.urg.ObjectFactory;
import jp.go.chisou.iur._1_5.urg.OfficesAndEmployeesType;
import jp.go.chisou.iur._1_5.urg.PopulationByAgeAndSexPropertyType;
import jp.go.chisou.iur._1_5.urg.PopulationByAgeAndSexType;
